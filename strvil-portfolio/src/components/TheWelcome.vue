...
<template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Another Item</template>

    I am typing here to see what it looks like on the page. I want this to look
    as good as possible and would like to try and learn how to use Vue properly
    in deployment.
  </WelcomeItem>
